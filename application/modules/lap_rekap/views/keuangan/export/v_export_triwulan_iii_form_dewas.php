                                        ...
                                        <?php 
                                                if ($no == 5)
                                                {
                                                    if ($row->TOTAL_NUM_TW_I == 0 || $row->TOTAL_DEN_TW_I == 0) 
                                                    {
                                                        ...
                                                        echo round(($row->TOTAL_NUM_TW_I + $row->TOTAL_NUM_TW_II + $row->TOTAL_NUM_TW_III) / ($row->TOTAL_DEN_TW_I + $row->TOTAL_DEN_TW_II + $row->TOTAL_DEN_TW_III), 2);
                                                    }
                                                } else if ($no == 6) {
                                                    if ($row->TOTAL_NUM_TW_I == 0 || $row->TOTAL_DEN_TW_I == 0) 
                                                    {
                                                    ...
                                                    if ($row->TOTAL_NUM_TW_I == 0 || $row->TOTAL_DEN_TW_I == 0) 
                                                    {
                                                        ...
                                                        echo round(($row->TOTAL_NUM_TW_I + $row->TOTAL_NUM_TW_II + $row->TOTAL_NUM_TW_III) / ($row->TOTAL_DEN_TW_I + $row->TOTAL_DEN_TW_II + $row->TOTAL_DEN_TW_III) * 1000, 5);
                                                    }
                                                } else {
                                                    if ($row->TOTAL_NUM_TW_I == 0 || $row->TOTAL_DEN_TW_I == 0) 
                                                    {

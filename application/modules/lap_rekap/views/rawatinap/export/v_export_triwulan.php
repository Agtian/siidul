            ...
            <div class="x_content">
                <div class="table-responsive">
                    <table id="" class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                <th height="50" colspan="8" align="center"><h4>Tabel Data Triwulan I : <?php echo $tahun; ?></h4></th>
                            </tr>
                            <tr class="bg-primary">
            ...
            <div class="x_content">
                <div class="table-responsive">
                    <table id="" class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                <th height="50" colspan="8" align="center"><h4>Tabel Data Triwulan II : <?php echo $tahun; ?></h4></th>
                            </tr>
                            <tr class="bg-primary">
                                <th rowspan="2" width="5"><center>NO</center></th>
                                <th rowspan="2" width="200"><center>INDIKATOR</center></th>
            ...
            <div class="x_content">
                <div class="table-responsive">
                    <table id="" class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                <th height="50" colspan="8" align="center"><h4>Tabel Data Triwulan III : <?php echo $tahun; ?></h4></th>
                            </tr>
                            <tr class="bg-primary">
                                <th rowspan="2" width="5"><center>NO</center></th>
                                <th rowspan="2" width="200"><center>INDIKATOR</center></th>
            ...
            <div class="x_content">
                <div class="table-responsive">
                    <table id="" class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                <th height="50" colspan="8" align="center"><h4>Tabel Data Triwulan IV : <?php echo $tahun; ?></h4></th>
                            </tr>
                            <tr class="bg-primary">
                                <th rowspan="2" width="5"><center>NO</center></th>
                                <th rowspan="2" width="200"><center>INDIKATOR</center></th>
                                ...
                                <td align="center"> 
                                    <?php
                                        if ($row->DEN_NOV == 0)
                                        {
                                            ...
                                            echo ($row->DEN_NOV * 4) / 60 / $tt_hari_nov; 
                                        } else if ($no == 5) {
                                            echo ($row->DEN_NOV * 7) / 60 / $tt_hari_nov; 
                                        } else {
                                            echo $row->DEN_NOV;
                                        }
                                    ?> 
                                ...
                                <td align="center"> 
                                    <?php
                                        if ($row->DEN_OKT == 0)
                                        {
                                            ...
                                            echo ($row->DEN_OKT * 4) / 60 / $tt_hari_okt; 
                                        } else if ($no == 5) {
                                            echo ($row->DEN_OKT * 7) / 60 / $tt_hari_okt; 
                                        } else {
                                            echo $row->DEN_OKT;
                                        }
                                    ?> 
                                ...
                                <td align="center"> 
                                    <?php
                                        if ($row->DEN_DES == 0)
                                        {
                                            ...
                                            echo ($row->DEN_DES * 4) / 60 / $tt_hari_des; 
                                        } else if ($no == 5) {
                                            echo ($row->DEN_DES * 7) / 60 / $tt_hari_des; 
                                        } else {
                                            echo $row->DEN_DES;
                                        }
                                    ?> 
                                        ...
                                        <?php 
                                            if ($no == '4')
                                            {
                                                if ($row->TOTAL_DEN == 0) 
                                                {
                                                    ...
                                                    $persen = ($row->TOTAL_DEN * 4) / 60 /  ($tt_hari_okt + $tt_hari_nov + $tt_hari_des);
                                                    echo $persen;
                                                }
                                            } else if ($no == 5) {
                                                if ($row->TOTAL_DEN == 0) 
                                                {
                                                    ...
                                                    $persen = ($row->TOTAL_DEN * 7) / 60 /  ($tt_hari_okt + $tt_hari_nov + $tt_hari_des);
                                                    echo $persen;
                                                }
                                            } else {
                                                if ($row->TOTAL_DEN == 0) 
                                        ...
                                        <?php
                                            if ($no == '4')
                                            {
                                                if ($row->TOTAL_DEN == 0) 
                                                {
                                                    ...
                                                    $total  = ($row->TOTAL_DEN * 4) / 60 / ($tt_hari_okt + $tt_hari_nov + $tt_hari_des);
                                                    $persen = $total / $row->TOTAL_DEN;
                                                ...
                                                if ($row->TOTAL_DEN == 0) 
                                                {
                                                    ...
                                                    $total  = ($row->TOTAL_DEN * 7) / 60 / ($tt_hari_okt + $tt_hari_nov + $tt_hari_des);
                                                    $persen = $total / $row->TOTAL_DEN;
                                                    echo gmdate('H:i:s', floor($persen * 3600));
                                                }
                                            } else {

        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br>
                        <?php echo form_open('lap_rekap/triwulan', 'class="form-horizontal "'); ?>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                    ...
                                    <a class="btn btn-primary" target="_blank" href="<?php echo base_url('lap_rekap/export_triwulan/').$id_ruang_sub.'/'.$tahun; ?>">Export PDF</a>
                                </div>
                            </div>
                        <?php echo form_close(); ?>
                    </div>
                                                ...
                                                <?php
                                                    if ($no == 2)
                                                    {
                                                        if ($row->TOTAL_NUM == 0) 
                                                        {
                                                            ...
                                                            $average = ($row->NUM_JAN / $tt_hari_jan) + ($row->NUM_FEB / $tt_hari_feb) + ($row->NUM_MAR / $tt_hari_mar) / 3;
                                                ...
                                                <?php 
                                                    if ($no == 2)
                                                    {
                                                        if ($row->TOTAL_NUM == 0 || $row->TOTAL_DEN == 0) 
                                                        {
                                                            ...
                                                            $tt_average = ($row->NUM_JAN / $tt_hari_jan) + ($row->NUM_FEB / $tt_hari_feb) + ($row->NUM_MAR / $tt_hari_mar) / 3;
                                                ...
                                                <?php
                                                    if ($no == 2)
                                                    {
                                                        if ($row->TOTAL_NUM == 0) 
                                                        {
                                                            ...
                                                            $average = ($row->NUM_APR / $tt_hari_apr) + ($row->NUM_MEI / $tt_hari_mei) + ($row->NUM_JUN / $tt_hari_jun) / 3;
                                                            echo round($average, 2);
                                                        }
                                                    } else {
                                                        if ($row->TOTAL_NUM == 0) 
                                                ...
                                                <?php 
                                                    if ($no == 2)
                                                    {
                                                        if ($row->TOTAL_NUM == 0 || $row->TOTAL_DEN == 0) 
                                                        {
                                                            ...
                                                            $tt_average = ($row->NUM_APR / $tt_hari_apr) + ($row->NUM_MEI / $tt_hari_mei) + ($row->NUM_JUN / $tt_hari_jun) / 3;
                                                            $time       = $tt_average / $row->TOTAL_DEN;
                                                            echo gmdate('H:i:s', floor($time * 86400));
                                                        }
                                                    } else {
                                                ...
                                                <?php
                                                    if ($no == 2)
                                                    {
                                                        if ($row->TOTAL_NUM == 0) 
                                                        {
                                                            ...
                                                            $average = ($row->NUM_JUL / $tt_hari_jul) + ($row->NUM_AGT / $tt_hari_agt) + ($row->NUM_SEP / $tt_hari_sep) / 3;
                                                            echo round($average, 2);
                                                        }
                                                    } else {
                                                        if ($row->TOTAL_NUM == 0) 
                                                ...
                                                <?php 
                                                    if ($no == 2)
                                                    {
                                                        if ($row->TOTAL_NUM == 0 || $row->TOTAL_DEN == 0) 
                                                        {
                                                            ...
                                                            $tt_average = ($row->NUM_JUL / $tt_hari_jul) + ($row->NUM_AGT / $tt_hari_agt) + ($row->NUM_SEP / $tt_hari_sep) / 3;
                                                            $time       = $tt_average / $row->TOTAL_DEN;
                                                            echo gmdate('H:i:s', floor($time * 86400));
                                                        }
                                                    } else {
                                                ...
                                                <?php
                                                    if ($no == 2)
                                                    {
                                                        if ($row->TOTAL_NUM == 0) 
                                                        {
                                                            ...
                                                            $average = ($row->NUM_OKT / $tt_hari_okt) + ($row->NUM_NOV / $tt_hari_nov) + ($row->NUM_DES / $tt_hari_des) / 3;
                                                            echo round($average, 2);
                                                        }
                                                    } else {
                                                        if ($row->TOTAL_NUM == 0) 
                                                ...
                                                <?php 
                                                    if ($no == 2)
                                                    {
                                                        if ($row->TOTAL_NUM == 0 || $row->TOTAL_DEN == 0) 
                                                        {
                                                            ...
                                                            $tt_average = ($row->NUM_OKT / $tt_hari_okt) + ($row->NUM_NOV / $tt_hari_nov) + ($row->NUM_DES / $tt_hari_des) / 3;
                                                            $time       = $tt_average / $row->TOTAL_DEN;
                                                            echo gmdate('H:i:s', floor($time * 86400));
                                                        }
                                                    } else {

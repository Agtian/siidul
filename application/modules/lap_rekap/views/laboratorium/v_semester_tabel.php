                                                ...
                                                <?php
                                                    if ($no == 2)
                                                    {
                                                        if ($row->TOTAL_NUM == 0) 
                                                        {
                                                            ...
                                                            $average = ($row->NUM_JAN / $tt_hari_jan) + ($row->NUM_FEB / $tt_hari_feb) + ($row->NUM_MAR / $tt_hari_mar) + ($row->NUM_APR / $tt_hari_apr) + ($row->NUM_MEI / $tt_hari_mei) + ($row->NUM_JUN / $tt_hari_jun) / 2;
                                                ...
                                                <?php 
                                                    if ($no == 2)
                                                    {
                                                        if ($row->TOTAL_NUM == 0 || $row->TOTAL_DEN == 0) 
                                                        {
                                                            ...
                                                            $tt_average = ($row->NUM_JAN / $tt_hari_jan) + ($row->NUM_FEB / $tt_hari_feb) + ($row->NUM_MAR / $tt_hari_mar) + ($row->NUM_APR / $tt_hari_apr) + ($row->NUM_MEI / $tt_hari_mei) + ($row->NUM_JUN / $tt_hari_jun) / 2;
                                                ...
                                                <?php
                                                    if ($no == 2)
                                                    {
                                                        if ($row->TOTAL_NUM == 0) 
                                                        {
                                                            ...
                                                            $average = ($row->NUM_JUL / $tt_hari_jul) + ($row->NUM_AGT / $tt_hari_agt) + ($row->NUM_SEP / $tt_hari_sep) + ($row->NUM_OKT / $tt_hari_okt) + ($row->NUM_NOV / $tt_hari_nov) + ($row->NUM_DES / $tt_hari_des) / 6;
                                                            echo round($average, 2);
                                                        }
                                                    } else {
                                                        if ($row->TOTAL_NUM == 0) 
                                                ...
                                                <?php 
                                                    if ($no == 3)
                                                    {
                                                        if ($row->TOTAL_NUM == 0 || $row->TOTAL_DEN == 0) 
                                                        {
                                                            ...
                                                            $tt_average = ($row->NUM_JUL / $tt_hari_jul) + ($row->NUM_AGT / $tt_hari_agt) + ($row->NUM_SEP / $tt_hari_sep) + ($row->NUM_OKT / $tt_hari_okt) + ($row->NUM_NOV / $tt_hari_nov) + ($row->NUM_DES / $tt_hari_des) / 6;
                                                            $time       = $tt_average / $row->TOTAL_DEN;
                                                            echo gmdate('H:i:s', floor($time * 86400));
                                                        }
                                                    } else {

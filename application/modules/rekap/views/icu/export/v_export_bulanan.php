                    ...
                    <td align="center"> 
                        <b>
                            <?php 
                                if ($no == 3) 
                                {
                                    if (empty($average_num))
                                    {
                                        echo "0";
                                    } else {
                                        echo round($average_num, 4);
                                    }
                                } else {
                                    echo $total_num; 
                                }
                            ...
                            <?php
                                if ($no == 3) {
                                    if ($average_num == 0)
                                    {
                                        ...
                                        $persen = ($average_num / ($total_den / $total_hari)) * 100;
                                        echo round($persen, 2).' %';
                                    }
                                } else if ($no == 4) {
                                    if ($total_num == 0)
                                    {
                                        ...
                                        $persen = ($total_num / ($total_den / $total_hari)) * 100;
                                        echo round($persen, 2).' %';
                                    }
                                } else {
                    ...
                    <td align="center"> 
                        <b>
                            <?php 
                                if ($no == 3) 
                                {
                                    if (empty($average_den))
                                    {
                                        echo "0";
                                    } else {
                                        echo round($average_den, 4);
                                    }
                                } else if ($no == 4) {
                                    echo $key->DEN;
                                } else {

                        ...
                        <?php $no = 1; foreach ($data_indikator->result() as $row) { ?>
                            ...
                            <div class="form-group">
                                <div class="col-md-2 col-sm-2 col-xs-2">
                                    <input type="text" class="form-control" name="num[]" placeholder="Numerator" value="0" required>
                                </div>
                                <div class="col-md-10 col-sm-10 col-xs-10"> <h4><?php echo $row->DETAIL_NUM; ?></h4> </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-2 col-sm-2 col-xs-2">
                                    <input type="text" class="form-control" name="den[]" placeholder="Denumerator" value="0" required>
                                </div>
